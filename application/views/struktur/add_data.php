            ...
            <div class="ibox-title">
                <h5>FORM TAMBAH DATA <small>Masukan data Mata kuliah di bawah ini</small></h5>
                    ...
                    <div class="ibox-content">
                        <form class= "form-horizontal" method="POST" action="<?php echo base_url()."index.php/struktur/simpan"; ?>">
                    <div class="form-group">
                        <label class="col-lg-2 control-label">Nama Struktur</label>
                        <div class="col-lg-3">
                            <input name="nama_struktur" type="text" placeholder="masukan nama struktur" class="form-control">
                        </div>
                    ...
                    <div class="form-group">
                        <div class="hr-line-dashed"></div>
                            <div class="col-lg-offset-10 col-lg-10">
                                <a href="<?php echo base_url()."index.php/struktur/simpan"; ?>"><button class="btn btn-sm btn-primary" type="submit">Simpan</button></a>
